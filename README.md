...
local Window = OrionLib:MakeWindow({Name = "RxnStore Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "RxnStore Hub"})

OrionLib:MakeNotification({
	Name = "RxnStore Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://121818447517665",
	Time = 7
})

OrionLib:MakeNotification({
	Name = "RxnStore Hub",
	Content = "RxnStore Hub",
	Image = "rbxassetid://121818447517665",
	Time = 25
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://121818447517665",
    PremiumOnly = false
})
...
W:AddLabel("[+] RxnStore Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "RxnStore Hub(Noitification)",
